...
(hello (4 6))
;expect Error: Cannot call 45 as it's not a procedure

(+ x 2)
;expect Error: Unknown identifier: x

cs61a
;expect Error: Unknown identifier: cs61a

(define (calc x y) (* (+ x y) (- y (/ x 2))))
;expect calc

(calc (4 7))
;expect Error: Cannot call 4 as it's not a procedure

(calc 4 7 8)
;expect Error: Too many arguments to function call.
...
, `(5 1 6)
;expect Error: Unquote outside of quasiquote

(* 'hello 7)
;expect Error: Argument of invalid type passed to *.
...
(define () (* x 2))
;expect Error: Invalid define form.

(define x (* x 2) 2)
;expect Error: (x (* x 2) 2) may contain at most 2 items.
...
(and () bye)
;expect Error: Unknown identifier: bye
...
(cond ((= (* 2 26) (/ 50 10)) 34) ((< 20 (* 2 4)) 'goodbye) (else (* 4 5)))
;expect 20
